locals {
  ...
  cgwWorkshopWebUrl = "https://trendcyberdefence.ca/login"
  awsConsoleUrl     = "https://us-east-1.signin.aws.amazon.com/oauth?SignatureVersion=4&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAJMOATPLHVSJ563XQ&X-Amz-Date=2020-09-15T01%3A22%3A25.664Z&X-Amz-Signature=8607a11b4cd112bc0b4e22dd35e27e329b2ec8c39f24664cfd1ce328addf7989&X-Amz-SignedHeaders=host&client_id=arn%3Aaws%3Aiam%3A%3A015428540659%3Auser%2Fhomepage&code_challenge=PfV5Rk8JQv4ZzeDE7jDtkVmRyGX6JHF9JPqntt_ywzk&code_challenge_method=SHA-256&nc2=h_ct&redirect_uri=https%3A%2F%2Fconsole.aws.amazon.com%2Fconsole%2Fhome%3Fnc2%3Dh_ct%26src%3Dheader-signin%26state%3DhashArgs%2523%26isauthcode%3Dtrue&response_type=code&src=header-signin&state=hashArgs%23"
  ...
  cgwAwsConformitySesHtmlPart     = "<style>.email-footer{font-family: 'Arial'; font-size: 1rem; padding-top: 1rem; font-weight: bold;}p{font-family: 'Arial';}table{border-collapse: collapse; font-family: 'Arial';}.marginLeft{margin-left: 2rem;}table, th, td{border: 0; padding: 1rem; color: black;}tr:nth-child(even){background: #ffb3b3;}tr:nth-child(odd){background: #ffcccc;}td:first-child{font-weight: bold;}.link{text-decoration: none;}.logo{max-height: 3rem; max-width: auto;}.title{margin: 0 1rem 3rem 0; font-size: 1.5rem; font-weight: bold; font-family: 'Arial'; width: 100%;}.alertTitle{padding: 1rem 1.5rem; background-color: #ff3333; font-size: 1.25rem; font-weight: bold; font-family: 'Arial';}</style><table> <tr> <td><img class='logo' src='https://www.trendmicro.com/content/dam/trendmicro/global/en/global/logo/logo-desktop.png'/></td><td class='title'>Cloud Governance Workshop</td></tr></table><p class='alertTitle'> Trend Micro Cloud One Conformity Alert</p><table class='marginLeft'><tr><td>Team Name</td><td>{{teamUuid}}</td></tr><tr> <td>Rule ID</td><td><a href='{{resolutionPageUrl}}' class='link'>{{ruleId}}</a></td></tr><tr> <td>Rule Title</td><td>{{ruleTitle}}</td></tr><tr> <td>Resource</td><td><a href='{{link}}' class='link'>{{resource}}</a></td></tr><tr> <td>Status</td><td>{{status}}</td></tr><tr> <td>Message</td><td>{{message}}</td></tr><tr> <td>Risk Level</td><td>{{riskLevel}}</td></tr><tr> <td>Category</td><td>{{categories}}</td></tr></table><p class='email-footer marginLeft'><a href='{{resolutionPageUrl}}' class='link' target='_blank'>Click here to open Cloud One Conformity &#187;</a></p>"
